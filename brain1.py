...
PREDICTED_LABELS = ["pituitary_tumor","glioma_tumor","no_tumor"]  # edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/79cec87b-de21-4c8c-a80f-324f91aa7559'  #Edit 2
...
st.title("Welcome to Brain Tumor Image Classifier Web App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("Brain tumor Image Classifier")#change according to your project   #edit 3
...
with tab2:
  ...
  #add github link
  st.link_button("My Github Repository", "https://github.com/goldkravi/brain_tumor")
#st.link_button("My Github Repository", "https://github.com/ShilpiShaw25/AP_Polytechnic_Image_classification")
  ...
  pdf_url = "https://raw.githubusercontent.com/goldkravi/brain_tumor/main/brain_tumor.pdf"
